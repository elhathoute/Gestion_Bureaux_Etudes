...
if(isset($_POST["clientID"])){
    ...
    WHERE d.remove = 0 AND $test AND dd.confirmed=1 AND bd.id_broker =$brokerId AND dd.service_name = '$srv_name'
    ...
    WHERE d.remove = 0 AND $test AND dd.service_name = '$srv_name' AND dd.confirmed=1
    ORDER BY d.date_creation;";
