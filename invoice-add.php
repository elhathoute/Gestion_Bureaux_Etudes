<?php
    ...
    if($_POST){
        ...
        $query = "INSERT INTO `invoice`(`id`, `F_number`, `id_client`, `sub_total`, `discount`, `net_total`, `type`, `status`,`remove_tva`, `comment`,`objet`,`located`)
                             VALUES (null,'$invoice_number','$client_id','$label_subTotal','$label_discount','$label_netTotal','Approved','accepter','$tva_checked','$invoice_comment','$objet_name','$located_txt')";
